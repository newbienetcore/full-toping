...
import { shuffleArray } from 'src/app/admin/components/shared/commonFunction';
import { Store } from '@ngrx/store';
import { selectabledata } from 'src/app/admin/store/crm/crm-selector';
import { fetchtableData } from 'src/app/admin/store/crm/crm.actions';
import { fetchStatData } from 'src/app/admin/store/analytics/analytics.actions';
import { selectData } from 'src/app/admin/store/analytics/analytics-selector';
import { fetchfeedbackdataData, fetchrentproprtydataData, fetchsalepropertydataData } from 'src/app/admin/store/real-estate/real-estate.action';
import { selectfeedData, selectrentData, selectsaleData } from 'src/app/admin/store/real-estate/real-estate-selector';
