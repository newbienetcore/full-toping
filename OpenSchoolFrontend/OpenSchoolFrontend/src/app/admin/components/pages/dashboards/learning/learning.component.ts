...
import { fetchinstructorData, fetchrecentcourseData } from 'src/app/admin/store/learning/learning.action';
import { selectData, selectrecentData } from 'src/app/admin/store/learning/learning-selector';
