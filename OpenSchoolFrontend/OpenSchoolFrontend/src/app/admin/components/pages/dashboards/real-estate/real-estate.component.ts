...
import { fetchfeedbackdataData, fetchpropertydataData, fetchrentproprtydataData, fetchsalepropertydataData } from 'src/app/admin/store/real-estate/real-estate.action';
import { selectData, selectfeedData, selectrentData, selectsaleData } from 'src/app/admin/store/real-estate/real-estate-selector';
