...
import { getChartColorsArray, shuffleArray } from 'src/app/admin/components/shared/commonFunction';
import { Store } from '@ngrx/store';
import { fetchdealData, fetchleadData, fetchtableData, fetchtaksData } from 'src/app/admin/store/crm/crm.actions';
import { selectabledata, selectdealData, selectleadData, selecttaskdata } from 'src/app/admin/store/crm/crm-selector';
