...
import { selectData } from 'src/app/admin/store/product/product.selector';
import { PageChangedEvent } from 'ngx-bootstrap/pagination';
import { deleteproductsList, fetchproductsList } from 'src/app/admin/store/product/product.action';
