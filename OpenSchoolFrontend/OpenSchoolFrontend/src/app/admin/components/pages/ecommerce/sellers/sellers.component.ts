...
import { addSellerdata, deleteSellerdataData, fetchsellerdata, updateSellerdataData } from 'src/app/admin/store/seller/seller.action';
import { selectData } from 'src/app/admin/store/seller/seller.selector';
import { Store } from '@ngrx/store';
import { seller1Chart } from 'src/app/admin/data/seller';
