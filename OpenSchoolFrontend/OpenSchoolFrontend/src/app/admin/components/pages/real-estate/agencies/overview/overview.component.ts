...
import { fetchlistingGridData } from 'src/app/admin/store/app-realestate/apprealestate.action';
import { selectData } from 'src/app/admin/store/app-realestate/apprealestate-selector';
import { selectagentData } from 'src/app/admin/store/agent/agent-selector';
import { Store } from '@ngrx/store';
import { fetchagentData } from 'src/app/admin/store/agent/agent.action';
