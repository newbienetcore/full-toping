...
import { fetchearningdataData } from 'src/app/admin/store/app-realestate/apprealestate.action';
import { selectearningdata } from 'src/app/admin/store/app-realestate/apprealestate-selector';
import { Store } from '@ngrx/store';
import { PageChangedEvent } from 'ngx-bootstrap/pagination';
import { earningcard } from 'src/app/admin/data';
