...
public interface IEfCoreReadOnlyRepository<TEntity, TDbContext> 
    ...
    where TDbContext : IAppDbContext
{
    ...
    Task<TEntity?> GetByIdWithCachingAsync(object id, CancellationToken cancellationToken = default);
