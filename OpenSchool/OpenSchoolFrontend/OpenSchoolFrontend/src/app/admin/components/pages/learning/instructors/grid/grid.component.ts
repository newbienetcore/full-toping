...
import { addinstructorgridData, deleteinstructorgridData, deleteinstructorgridFailure, fetchinstructorgridData, updateinstructorgridData } from 'src/app/admin/store/learning-instructor/instructor.action';
import { selectgridData } from 'src/app/admin/store/learning-instructor/instructor.selector';
