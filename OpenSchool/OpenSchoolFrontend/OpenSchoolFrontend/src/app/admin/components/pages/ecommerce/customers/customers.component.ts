...
import { addcustomerData, deletecustomerData, fetchcustomerData, updatecustomerData } from 'src/app/admin/store/customer/customer.action';
import { selectData } from 'src/app/admin/store/customer/customer.selector';
