...
import { addinstructorlistData, deleteinstructorlistData, fetchinstructorListData, updateinstructorlistData } from 'src/app/admin/store/learning-instructor/instructor.action';
import { selectListData } from 'src/app/admin/store/learning-instructor/instructor.selector';
