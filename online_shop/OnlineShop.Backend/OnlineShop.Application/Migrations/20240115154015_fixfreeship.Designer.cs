...
namespace OnlineShop.Application.Migrations
{
    ...
    [Migration("20240115154015_fixfreeship")]
    partial class fixfreeship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ProductColor", b =>
                {
                    b.HasOne("OnlineShop.Core.Schemas.ColorSchema", "Color")
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ProductSize", b =>
                {
                    ...
                    b.HasOne("OnlineShop.Core.Schemas.SizeSchema", "Size")
                        .WithMany("ProductSizes")
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.VoucherSchema", b =>
                {
                    b.HasOne("OnlineShop.Core.Schemas.OrderSchema", null)
                        .WithMany("Vouchers")
                        .HasForeignKey("OrderSchemaId");
                });
