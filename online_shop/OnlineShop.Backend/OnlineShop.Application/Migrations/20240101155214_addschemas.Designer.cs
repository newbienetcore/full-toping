...
namespace OnlineShop.Application.Migrations
{
    ...
    [Migration("20240101155214_addschemas")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ColorSchema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ImageSchema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ProductColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ProductSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.SizeSchema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ProductColor", b =>
                {
                    b.HasOne("OnlineShop.Core.Schemas.ColorSchema", "ColorSchema")
                        .WithMany()
                        .HasForeignKey("ColorSchemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShop.Core.Schemas.ProductSchema", "ProductSchema")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ProductSchema", b =>
                {
                    b.HasOne("OnlineShop.Core.Schemas.BrandSchema", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShop.Core.Schemas.CategorySchema", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("OnlineShop.Core.Schemas.ProductSize", b =>
                {
                    ...
                    b.HasOne("OnlineShop.Core.Schemas.SizeSchema", "SizeSchema")
                        .WithMany()
                        .HasForeignKey("SizeSchemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductSchema");

                    b.Navigation("SizeSchema");
                });
